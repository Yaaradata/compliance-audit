...
class EvidenceBasedQuestion(Base):
    ...
    gcs_auto_level: Mapped[str | None] = mapped_column(Text)
    gcs_services: Mapped[str | None] = mapped_column(Text)
    question_level_gcs_sources: Mapped[str | None] = mapped_column(Text)
    azure_auto_level: Mapped[str | None] = mapped_column(Text)
    azure_services: Mapped[str | None] = mapped_column(Text)
    question_level_azure_sources: Mapped[str | None] = mapped_column(Text)
