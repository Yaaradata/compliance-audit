"""
SWIFT Evidence Item → AWS API mapping. Used for control detail aws_calls.
"""
from typing import TypedDict

EvidenceItemSpec = TypedDict(
    "EvidenceItemSpec",
    {"item_id": str, "name": str, "aws_services": list, "apis": list, "evidence_type": str, "feasibility": str, "control_ids": list},
)
...
def get_apis_for_control(item_codes: list[str]) -> dict:
    """Return aws_apis and by_evidence_item for given item codes."""
    by_item: list[dict] = []
