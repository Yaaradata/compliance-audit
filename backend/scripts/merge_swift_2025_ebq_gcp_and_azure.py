#!/usr/bin/env python3
"""
Merge SWIFT 2025 evidence question rows: GCS columns from Evidence_Based_Questions_2025.csv
plus Azure columns from Evidence_Based_Questions_2025_Azure.csv (same ids).

Usage:
  python backend/scripts/merge_swift_2025_ebq_gcp_and_azure.py --out evidence_based_questions_2025_gcp_azure_merged.csv
"""
...
DEFAULT_GCP = REPO_ROOT / "Evidence_Based_Questions_2025.csv"
DEFAULT_AZURE = REPO_ROOT / "Evidence_Based_Questions_2025_Azure.csv"


def main() -> int:
    p = argparse.ArgumentParser(description="Merge GCS + Azure EBQ CSV rows (2025) by id.")
    p.add_argument("--gcp", type=Path, default=DEFAULT_GCP, help="CSV with gcs_* columns")
