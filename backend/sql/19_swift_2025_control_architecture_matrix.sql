...
UPDATE swift_2025.controls SET name = 'Customer Environment Protection',          architecture_applicability = '{A4}' WHERE id = '1.5';
...
UPDATE swift_2025.controls SET name = 'External Transmission Data Protection',    architecture_applicability = '{A1,A2,A3,A4}' WHERE id = '2.5A';
...
UPDATE swift_2025.controls SET name = 'Application Hardening',                    architecture_applicability = '{A1,A2,A3}' WHERE id = '2.10';
...
UPDATE swift_2025.controls SET name = 'Software Integrity',                       architecture_applicability = '{A1,A2,A3,A4}' WHERE id = '6.2';
UPDATE swift_2025.controls SET name = 'Database Integrity',                      architecture_applicability = '{A1,A2,A4}' WHERE id = '6.3';
UPDATE swift_2025.controls SET name = 'Logging and Monitoring',                   architecture_applicability = '{A1,A2,A3,A4,B}' WHERE id = '6.4';
UPDATE swift_2025.controls SET name = 'Intrusion Detection',                     architecture_applicability = '{A1,A2,A3,A4}' WHERE id = '6.5A';
