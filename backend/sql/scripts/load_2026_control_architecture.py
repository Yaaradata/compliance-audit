#!/usr/bin/env python3
"""
Load 2026 control architecture applicability from control_architecture_applicability_2026.json
into swift_2026.controls (update name and architecture_applicability).

Run from repo root:
  python backend/sql/scripts/load_2026_control_architecture.py

Requires: 14_seed_swift_2026_domains_controls.sql applied first.
...
JSON_PATH = REPO_ROOT / "ref-docs" / "swift" / "2026" / "control_architecture_applicability_2026.json"
SCHEMA = "swift_2026"
