...
UPDATE swift_2026.controls SET name = 'Swift Environment Protection',            architecture_applicability = '{A1,A2,A3,A4,B}' WHERE id = '1.1';
...
UPDATE swift_2026.controls SET name = 'Internal Data Flow Security',             architecture_applicability = '{A1,A2,A3,A4}' WHERE id = '2.1';
...
UPDATE swift_2026.controls SET name = 'Back Office Data Flow Security',           architecture_applicability = '{A1,A2,A3,A4,B}' WHERE id = '2.4';
UPDATE swift_2026.controls SET name = 'Back Office Data Flow Security',           architecture_applicability = '{A1,A2,A3,A4,B}' WHERE id = '2.4A';
...
UPDATE swift_2026.controls SET name = 'Application Hardening',                    architecture_applicability = '{A1,A2,A3,A4,B}' WHERE id = '2.10';
...
UPDATE swift_2026.controls SET name = 'Software Integrity',                      architecture_applicability = '{A1,A2,A3,A4,B}' WHERE id = '6.2';
UPDATE swift_2026.controls SET name = 'Database Integrity',                       architecture_applicability = '{A1,A2,A3,A4,B}' WHERE id = '6.3';
UPDATE swift_2026.controls SET name = 'Logging and Monitoring',                  architecture_applicability = '{A1,A2,A3,A4,B}' WHERE id = '6.4';
UPDATE swift_2026.controls SET name = 'Intrusion Detection',                       architecture_applicability = '{A1,A2,A3,A4,B}' WHERE id = '6.5A';
