...
export const DASHBOARD_PRIMARY_GRADIENT: Record<DashboardButtonRole, string> = {
  ...
  it_sme: "linear-gradient(135deg, #D2691E 0%, #B45309 100%)",
...
export const DASHBOARD_SECONDARY_GRADIENT: Record<DashboardButtonRole, string> = {
  ...
  it_sme: "linear-gradient(135deg, #fdba74 0%, #fb923c 100%)",
...
> = {
  ...
  it_sme: { border: "#D2691E", text: "#9a3412", hoverBg: "color-mix(in srgb, #ea580c 22%, white)" },
