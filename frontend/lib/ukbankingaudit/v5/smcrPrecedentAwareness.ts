...
/**
 * v5-only attestation cutoff for the closed Final Notice population.
...
export function attestationCutoffForSmf(smfId: string, lastAttestationDate: string): string {
  ...
  // v5 demo: when mock lastAttestation is recent, extend the closed population back to floor.
