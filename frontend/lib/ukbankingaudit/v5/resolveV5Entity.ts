/**
 * Resolve v5 drawer entities by kind. Used by UKBankingControlTrace.resolveEntity
 * and by the evidence-ref regression test — keep them in lockstep.
 */
import { CRSA_DATA, CRSA_MECHANISM_TAGS, DOMAIN_EVIDENCE } from "./riskDomainsV5";
...
import type { V5RefKind } from "./refRouter";
...
export function getV5Precedent(id: string): Precedent | undefined {
 ...
 */
export function resolveV5Entity(
  kind: V5RefKind | string,
  id: string,
  deps: ResolveV5Deps = {},
): unknown | null {
