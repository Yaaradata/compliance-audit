/**
 * v6-only curated insights that fill persona-specific coverage gaps.
 *
...
export const V6_PERSONA_INSIGHTS = [
  // ── CRO (SMF4) ─────────────────────────────────────────────────────────
  {
    id: "V6-CRO-LIQUIDITY-HEADROOM",
  ...
  {
    id: "V6-CRO-MARKET-RISK-OWNERSHIP",
  ...
  {
    id: "V6-CRO-CREDIT-VALIDATION-DEPENDENCY",
  ...
  {
    id: "V6-SMF16-CONSUMER-DUTY-CADENCE",
  ...
  {
    id: "V6-SMF16-REGULATORY-FINDINGS-CADENCE",
    type: "monitoring_cadence",
  ...
  {
    id: "V6-SMF16-BOARD-OVERSIGHT-CONTROL",
  ...
  {
    id: "V6-SMF16-SANCTIONS-CONTROL-READACROSS",
