/**
 * v6 signal copy — generated from a closed enum of PREDICATES, never free prose.
 *
 ...
 * ESLint no-restricted-syntax rule bans the overstated literals across all of v6.
 *
