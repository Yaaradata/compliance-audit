...
import type { V4SourceTag } from "@/lib/Srilanka_Retail/v4/types";

const TAG_LABEL: Record<V4SourceTag, string> = {
  SOURCED: "SOURCED",
  VERIFIED: "VERIFIED",
...
function tagDot(C: ReturnType<typeof useKeystoneV4Colors>, tag: V4SourceTag) {
  const map: Record<V4SourceTag, string> = {
    SOURCED: C.green,
    VERIFIED: C.green,
...
export function Chip({ tag }: { tag: V4SourceTag }) {
