...
import { CTRLS, REGS, rollupItems } from "@/lib/Srilanka_Retail/v4/constants";
import type { HeadlineMetric, KeystoneDataV4 } from "@/lib/Srilanka_Retail/v4/types";
...
export function ScreenC5({ store }: { store: KeystoneDataV4 }) {
  const C = useKeystoneV4Colors();
