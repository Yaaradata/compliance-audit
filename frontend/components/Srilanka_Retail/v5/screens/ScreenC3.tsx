...
import type { AgeingBucket, KeystoneDataV5 } from "@/lib/Srilanka_Retail/v5/types";
import { fmtRs } from "@/lib/Srilanka_Retail/v5/format";
...
export function ScreenC3({ store }: { store: KeystoneDataV5 }) {
  const C = useKeystoneV5Colors();
