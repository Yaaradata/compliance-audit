...
import {
  ...
  CoverageGapPanelV6,
} from '@/components/UKBankingAudit/v6/coverage';
import { buildEnforcementNotices } from '@/lib/ukbankingaudit/v6/enforcementCoverage';
import { v6RefKind } from '@/lib/ukbankingaudit/v6/refRouter';

/** v6-only lens catalog — sixth enforcement tab; shared _shared COVERAGE_LENSES untouched. */
const COVERAGE_LENSES_V6 = [
...
export function ObligationCoverageMapV6({ openDrawer, setActiveScreen, setSelectedGSRId }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <UnassessedNoticeStrip
        ...
        onOpenEvidence={(ref) => openDrawer?.(v6RefKind(ref), ref, 'coverageMap')}
      />

      {/* Lens tabs */}
      <div className="flex items-center gap-1 border-b border-slate-200 overflow-x-auto">
        {COVERAGE_LENSES_V6.map(lens => (
      ...
      {activeLens === 'gaps'      && <CoverageGapPanelV6 setSelectedGSRId={setSelectedGSRId} setActiveScreen={setActiveScreen} />}
