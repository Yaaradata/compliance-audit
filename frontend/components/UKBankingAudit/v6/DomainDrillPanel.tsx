...
import { matchPrecedents } from "@/lib/ukbankingaudit/v6/precedentCorpus";
import { CRSA_DATA, CRSA_MECHANISM_TAGS } from "@/lib/ukbankingaudit/v6/riskDomainsV6";
              ...
              <div key={sub.name}>
                ...
                {open ? (
                  ...
                  >
                    ...
                    {sub.status === "RED" || sub.status === "AMBER" ? (
                      <PathToGreenStrip entityRef={sub.name} />
                    ) : null}
                  </div>
                ) : null}
              </div>
