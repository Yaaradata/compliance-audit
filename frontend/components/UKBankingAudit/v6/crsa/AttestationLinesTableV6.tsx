...
import { RACMRefBadge, StatusBadge } from "@/components/UKBankingAudit/v6/screens/_shared";
import {
...
export function AttestationLinesTableV6({ cycle, onDrillLine, onOpenEvidence }: Props) {
