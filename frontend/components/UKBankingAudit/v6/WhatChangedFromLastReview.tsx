...
import type { ChangeRowV6 } from "@/lib/ukbankingaudit/v6/whatChangedV6";
...
/** v6 What Changed — each row's derivation is an evidence-bound claim, never a bare confidence %. */
