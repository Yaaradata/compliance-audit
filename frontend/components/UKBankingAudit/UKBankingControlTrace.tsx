...
} from '@/components/UKBankingAudit/v5/screens/_shared';
import { SMCRReasonableStepsWorkspaceV5 } from '@/components/UKBankingAudit/v5/screens/SMCRReasonableStepsWorkspaceV5';
import { ObligationCoverageMapV5 } from '@/components/UKBankingAudit/v5/screens/ObligationCoverageMapV5';
import { MLROWorkspaceV5 } from '@/components/UKBankingAudit/v5/screens/MLROWorkspaceV5';
import { CRSACycleCockpitV5 } from '@/components/UKBankingAudit/v5/screens/CRSACycleCockpitV5';
import { AIInsightExplorerV5 } from '@/components/UKBankingAudit/v5/screens/AIInsightExplorerV5';
import { AIInsightDetailV5 } from '@/components/UKBankingAudit/v5/screens/AIInsightDetailV5';
...
export default function UKBankingControlTrace({ variant = 'v2' } = {}) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans antialiased">
      ...
      {/* ── DRAWER ──────────────────────────────────────────────────────── */}
      {drawer.isOpen && (
        <DetailDrawer drawer={drawer} closeDrawer={closeDrawer} drillFromDrawer={drillFromDrawer} drillBack={drillBack} setActiveScreen={setActiveScreen} setSelectedSMFId={setSelectedSMFId} setSelectedPackId={setSelectedPackId} setSelectedTestId={setSelectedTestId} variant={variant} />
      )}
    </div>
  );
}
...
// ─── DRAWER ───────────────────────────────────────────────────────────────
function DetailDrawer({ drawer, closeDrawer, drillFromDrawer, drillBack, setActiveScreen, setSelectedSMFId, setSelectedPackId, setSelectedTestId, variant = 'v2' }) {
