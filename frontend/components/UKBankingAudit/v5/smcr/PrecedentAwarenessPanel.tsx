...
import { formatGbp } from "@/lib/ukbankingaudit/v5/precedentCorpus";
import { CRSA_DATA, RISK_DOMAINS_V4 } from "@/lib/ukbankingaudit/v5/riskDomainsV5";
import type { CrsaControl, Precedent, RagStatus } from "@/lib/ukbankingaudit/v5/types";
import {
