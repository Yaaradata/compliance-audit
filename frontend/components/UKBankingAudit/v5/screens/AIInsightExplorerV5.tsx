...
import {
  ...
  type UkbaPersonaId,
} from '@/lib/ukbankingaudit/v5/insightViews';
...
/**
 * v5 AI Insight Explorer — persona-scoped, screen-owned, deduplicated.
 * Board detector signals owned by CRO stay on Board View and do not reappear here.
 */
export function AIInsightExplorerV5({ openDrawer, activePersona = 'cro' }: Props) {
  const catalogue: AIInsightV5[] = useMemo(
