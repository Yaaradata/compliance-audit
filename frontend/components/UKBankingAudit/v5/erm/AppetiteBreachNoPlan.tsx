...
import { KriBar } from "@/components/UKBankingAudit/v5/KriBar";
import { RemediationTimeline } from "@/components/UKBankingAudit/v5/RemediationTimeline";
import { formatConsequence } from "@/lib/ukbankingaudit/v5/precedentCorpus";
import { getPrecedentById } from "@/lib/ukbankingaudit/v5/precedentCorpus";
import type { AppetiteBreachNoPlanSignal } from "@/lib/ukbankingaudit/v5/appetiteBreachNoPlan";
import { RISK_DOMAINS_V4 } from "@/lib/ukbankingaudit/v5/riskDomainsV5";
