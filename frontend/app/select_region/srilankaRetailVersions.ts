export type SrilankaRetailVersion = "v1" | "v2" | "v4";

export const LATEST_SRILANKA_RETAIL_VERSION: SrilankaRetailVersion = "v4";
...
export const SRILANKA_RETAIL_VERSION_ORDER: SrilankaRetailVersion[] = ["v4", "v2", "v1"];
